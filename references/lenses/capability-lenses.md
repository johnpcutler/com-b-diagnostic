...
**Use when:** Revealing the difference between missing knowledge, missing procedural know-how, and insufficient fluency -- especially when the person has heard the material but still cannot execute the behavior reliably.

**Diagnostic question:** Is the issue facts, concepts, procedures, or fluency?
...
**Use when:** Revealing faulty causal understanding, incomplete structural understanding, and reasoning from the wrong model of the world -- especially coherent-seeming but wrong decisions from the wrong internal representation.

**Diagnostic question:** Are people reasoning from the right model of the system or situation?
...
**Use when:** Revealing whether people have the judgmental competence to select, prioritize, and adapt actions well, especially outside routine cases -- including when facts exist but judgment, decision rules, or experience in applying them is the gap.

**Diagnostic question:** Can they make workable judgments under the real conditions of the task?
...
**Use when:** Revealing the perceptual and recognition demands of the behavior -- especially subtle-signal tasks, anomaly detection, and expert pattern recognition even when motivation is high.

**Diagnostic question:** Can they perceive and recognize the right signals in time?
...
**Use when:** Revealing overconfidence, underconfidence, poor self-monitoring, and failure to notice one's own knowledge gaps -- especially the gap between lacking knowledge and not knowing you lack it.

**Diagnostic question:** Do they know when they do not know, and can they regulate accordingly?
...
**Use when:** Revealing conceptual drift, incompatible meanings, and team-level capability failures that masquerade as individual ignorance -- especially when people are not simply untrained but work from different meanings and incompatible conceptual objects.

**Diagnostic question:** Are people working from compatible concepts and definitions?
...
**Use when:** Revealing the difference between `cannot perform` and `cannot yet perform alone` -- especially learning-in-progress situations, guided workflows, job aids, and capability emerging but not yet consolidated.

**Diagnostic question:** Can they perform only with support, or independently?
...
**Use when:** Revealing whether physical performance is novice, emerging, fluent, or automated -- especially when the person understands the task but still fails at bodily execution.

**Diagnostic question:** How practiced and fluent is the bodily skill?
...
**Use when:** Revealing dexterity limits, coordination breakdowns, interference, and poor motor organization -- especially execution-quality problems not primarily about strength or motivation.

**Diagnostic question:** How well organized and stable is the movement?
...
**Use when:** Revealing endurance limits, fatigue effects, recovery deficits, and performance drift -- especially when the person can do the task at first but not sustainably or repeatedly.

**Diagnostic question:** Can the behavior be sustained over time?
...
**Use when:** Revealing whether the person can perform the required bodily actions at all -- especially the can/cannot boundary for concrete physical tasks.

**Diagnostic question:** Can the person perform the required bodily actions at all?
...
**Use when:** Revealing when task demands exceed bodily reach, posture tolerance, force tolerance, repetition tolerance, or movement efficiency -- especially when bodily demands are too high or poorly matched to the actor.

**Diagnostic question:** Do the bodily demands of the task exceed the actor's sustainable capacity?
